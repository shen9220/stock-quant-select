...
| **stock-assistant** ⭐ | 1.0.0 | 2个 | 智能选股助手 |
...
| 特性 | using-coze-cli | github | stock-assistant ⭐ |
|------|----------------|--------|-------------------|
| **主要功能** | Coze CLI 工具链 | GitHub 代码管理 | 智能选股分析 |
| **文档数量** | 15个 | 1个 | 2个 |
| **核心依赖** | coze CLI | Git | A股数据源 |
| **应用场景** | 文件上传、内容生成、项目部署 | 版本控制、团队协作 | 股票筛选、估值分析、技术评分 |
| **复杂度** | 高（多模块） | 中（核心功能） | 低（开箱即用） |
| **安装状态** | ✅ 已下载 | ✅ 已下载 | ✅ 已下载 |
| **依赖检查** | - | ✅ Git 已安装 | 无需额外依赖 |

---

## 技能包 3: stock-assistant ⭐

### 基本信息

- **技能名称**: stock-assistant (智能选股助手)
- **技能ID**: 95530120-1611-4683-8e5b-26a460de7f74
- **版本**: 1.0.0
- **描述**: 智能选股助手：基于A股市场数据的智能选股工具，支持多维度筛选、估值分析、技术指标评分
- **下载时间**: 2024-04-27
- **文档数**: 2个 Markdown 文件
...
| 功能 | 说明 |
|------|------|
| **智能选股** | 按行业、市值、估值、涨跌幅、股息率等多维度筛选 |
| **估值评分** | 基于 PE/PB 历史百分位评估当前估值水平 |
| **技术评分** | 均线、量价、动量、形态综合评分 |
| **行业对比** | 将目标股票与同行业公司进行对比 |
...
1. **行业选股**: "帮我选几只低估值的银行股"
2. **个股分析**: "这只股票能买吗？帮我分析一下"
3. **策略选股**: "帮我找几只高股息的股票"
4. **技术分析**: "帮我找几只技术面金叉的股票"
5. **热点分析**: "最近什么板块比较热门？"
...
```
1. 加载 stock-assistant 技能
2. 直接提问：帮我选几只银行股
```

详细使用方法请查看：
- `STOCK_ASSISTANT_QUICK.md` - 快速使用指南
- `downloaded_skills/stock-assistant/SKILL.md` - 完整文档
